                  ...
                  <div class="regcontainer ">
                    <div class="container-login100 ">
                      <div class="wrap-login100">
                        ...
                        <form class="login100-form validate-form form-control" onsubmit="return validateForm()" action="execute.php" method="post" enctype="multipart/form-data">
                            <?php
...
<!--  ADD IMAGE -->
      <div class="wrap-input100 validate-input m-b-18" data-validate = "Upload profile-image is required">
                            <label for="formFile" class="label-input100">Upload_Img:</label>
                            <input class="form-control" id="inputSP2" type="file" name="profile_pic" accept="image/*">
                            <span class="focus-input100"></span>
...
<!--  -->
                          ...
                          <div class="wrap-input100 validate-input m-b-26" data-validate="Birthday is required">
                            ...
                            <input class="input100 form-control" id="cntn" type="text" maxlength="11" name="contactno" placeholder="Enter your phone number">
                            <span class="focus-input100"></span>
                          </div>
