...
// let displayall = currentMon + currentDay + currentYear;
...
//         }else if (1==getDay(year,mon,i)){
//             list.style.color = 'black';
//         }else if (2==getDay(year,mon,i)){
//             list.style.color = 'black';
//         }else if (3==getDay(year,mon,i)){
//             list.style.color = 'black';
//         }else if (4==getDay(year,mon,i)){
//             list.style.color = 'black';
//         }else if (5==getDay(year,mon,i)){
//             list.style.color = 'black';
//         }else if(6==getDay(year,mon,i)){
...
// function setMonthTitle(mon,year, i){
//     month.textContent =`${year} / ${mon} / ${i}`;
...
//         mon = mon+1;
//     }
//     setMonthTitle(year,mon, i);
//     makeCalendar(year,mon,getDayOfMon(mon,year,i));
// }
...
//     setMonthTitle(year,mon);
//     makeCalendar(year,mon,getDayOfMon(mon,year));
//     todoTitle.textContent = `What are you going to do on ${mon}. ${currentDay}, ${year} 👀⁉`;
//     displayToDoOnDays();
// }
...
//         clearEvent();
//         todoTitle.textContent = `What are you going to do on ${mon}. ${event.target.textContent}, ${year} 👀⁉`;
