<?php 
  ...
  if(mysqli_query($con,"INSERT INTO member(fname, mi, lname, address, gender, contactno, birthday, usertype, username, password)VALUES('$fname','$mi', '$lname','$address','$gender','$contactno','$birthday','$usertype', '$username', '$password')")){ 
      $IdGenerated = mysqli_insert_id($con);
    
      $ImgName = "$IdGenerated.jpg";
