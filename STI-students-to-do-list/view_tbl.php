	...
	while($rowUsers = mysqli_fetch_array($all_records, MYSQLI_ASSOC)){
		...
		$displayResult .=  '
							...
							<tr>
								...
								<td style="border:1px solid black;"><figure style="width: 84px;height: 84px;overflow: hidden;border-radius: 50%;">
										<img src="uploads/'.$rowUsers['mem_id'].'.jpg" alt="Admin" style="width: 100%;">
									</figure></td>
